class EventSystem {
  ...
  processEvents(deltaTime) {
    // Sem jogadores: não há eventos nem logs
  ...
  triggerEvent(eventName) {
    ...
    switch (eventName) {
      case 'wildAnimalAttack':
        triggered = this.handleWildAnimalAttack();
        break;
      case 'treasureDiscovery':
        triggered = this.triggerTreasureDiscovery();
        break;
      case 'banditRaid':
        triggered = this.triggerBanditRaid();
        break;
      case 'merchantCaravan':
        triggered = this.handleMerchantCaravan();
        break;
      case 'resourceBonanza':
        triggered = this.triggerResourceBonanza();
        break;
      case 'wanderingHero':
        triggered = this.triggerWanderingHero();
        break;
    }
