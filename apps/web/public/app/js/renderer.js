class Renderer {
    ...
    createTileMaterials() {
        ...
        try {
            textureLoader.load((typeof ageAsset==='function'?ageAsset('/images/tiles/grass.jpg'):'/images/tiles/grass.jpg'), (texture) => {
            ...
            textureLoader.load((typeof ageAsset==='function'?ageAsset('/images/tiles/forest.jpg'):'/images/tiles/forest.jpg'), (texture) => {
                texture.wrapS = THREE.RepeatWrapping;
                texture.wrapT = THREE.RepeatWrapping;
            ...
            textureLoader.load((typeof ageAsset==='function'?ageAsset('/images/tiles/sand.jpg'):'/images/tiles/sand.jpg'), (texture) => {
                texture.wrapS = THREE.RepeatWrapping;
                texture.wrapT = THREE.RepeatWrapping;
            ...
            textureLoader.load((typeof ageAsset==='function'?ageAsset('/images/tiles/mountain.jpg'):'/images/tiles/mountain.jpg'), (texture) => {
                texture.wrapS = THREE.RepeatWrapping;
                texture.wrapT = THREE.RepeatWrapping;
            ...
            textureLoader.load((typeof ageAsset==='function'?ageAsset('/images/tiles/water.jpg'):'/images/tiles/water.jpg'), (texture) => {
                texture.wrapS = THREE.RepeatWrapping;
                texture.wrapT = THREE.RepeatWrapping;
